...
- [ ] T015 [US1] Implement Jupyter environment detection in src/HsJupyter/CLI/Install.hs
- [ ] T016 [US1] Implement kernelspec directory discovery and validation in src/HsJupyter/CLI/Install.hs
- [ ] T017 [US1] Implement kernel.json generation with constitutional compliance in src/HsJupyter/CLI/Install.hs
